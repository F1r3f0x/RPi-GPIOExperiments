...
# Tones: Notes / Freq (Hz)
# Stolen from: https://github.com/bhagman/Tone
tones = {
    "B0": 31,
    "C1": 33,
    "CS1": 35,
...
for tone in [tones['CS3'], 'P', tones['E3'], tones['CS3'], tones['CS3'], tones['F3'],]:
    if tone != 'P':
        pwmBuzzer.frequency = tone
        pwmBuzzer.value = 0.8
    sleep(0.25) # this is our tempo
    pwmBuzzer.value = 0
